...
<body>
    ...
    <div class="container mt-2">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Νέα Αίτηση</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="container-fluid">
        <form id="regForm" method='post' action='new-request.php' enctype="multipart/form-data">
            ...
            <h6 class="text-center fw-lighter mb-5">Προσωρινά Αποθηκευμένο</h6>
                    ...
                    <div class="d-flex flex-column justify-content-between">
                        ...
                        <div class="col-md-6 d-flex flex-column mt-3">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <button type="button" class="btn" data-bs-toggle="tooltip" data-bs-placement="right" title="Το Τ.Κ. αποτελείται από 5 ψηφία">
                                    <i class="bi bi-info-circle"></i>
                                </button>
                            </div>
            ...
            <div class="tab">
                <div class="container mt-5" style="width: 70%;">
                        ...
                        <div class="d-flex flex-column justify-content-between mt-4">
                            <div class="col-md-3">
                                <label for="diploma_country">Χώρα Έκδοσης Πτυχίου</label>
            ...
            <div class="tab">
                <div class="container mt-5" style="width: 70%;">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div id="payment-error" class="error unchecked">Το πεδίο είναι υποχρεωτικό</div>
                    </div>
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="col-md-5 d-flex align-items-center justify-content-between mt-3">
                            <input type="radio" id="delivery" name="after_issued" value="Αποστολή Έντυπου" onclick="showAddress()" <?php if ($controller->getData('after_issued')!=null && $controller->getData('after_issued')=="Αποστολή Έντυπου") echo "checked";?>>
                            <div class="d-flex flex-column align-items-center justify-content-end">
                                <label for="delivery">Αποστολή Έντυπου</label>
                            </div>
                        </div>
                        <div class="col-md-5 d-flex align-items-center justify-content-between mt-3" onclick="showAddress()" <?php if ($controller->getData('after_issued')!=null && $controller->getData('after_issued')=="Αποστολή Έντυπου και e-statement") echo "checked";?>>
                            <input type="radio" id="both" name="after_issued" value="Αποστολή Έντυπου και e-statement">
                            <label for="both">Και τα δύο παραπάνω</label>
                        </div>
